...
public class CommentController {
	...
	/*
	 * @GetMapping("/remove") public String remove(@RequestParam("userId") String
	 * userId, @RequestParam("isbn") String isbn, RedirectAttributes rttr) {
	 * log.info("remove.........:" + userId + isbn); service.remove(userId, isbn);
	 * log.info("remove.........:" + userId + "," + isbn);
	 * rttr.addFlashAttribute("result", "success"); return
	 * "redirect:/comment/list?isbn=" + comment.getIsbn(); }
	 * 
	 * @GetMapping("/modify") public String modify(@RequestParam("userId") String
	 * userId, @RequestParam("isbn") String isbn,
	 * 
	 * @RequestParam("content") int content, RedirectAttributes rttr) {
	 * log.info("modify.........:" + userId + bookName + amount);
	 * service.modify(userId, bookName, amount); rttr.addFlashAttribute("result",
	 * "success"); return "redirect:/comment/list?isbn=" + comment.getIsbn(); }
	 */
}
